...
:ready
REM Maximize the TradingView window after launch
echo Maximizing TradingView window...
powershell -NoProfile -Command "Add-Type -Namespace Win32 -Name NativeMethods -MemberDefinition '[DllImport(\"user32.dll\")]public static extern bool ShowWindow(IntPtr hWnd,int nCmdShow);' -PassThru | Out-Null; Get-Process -Name TradingView -ErrorAction SilentlyContinue | ForEach-Object { [Win32.NativeMethods]::ShowWindow($_.MainWindowHandle, 3) }"
